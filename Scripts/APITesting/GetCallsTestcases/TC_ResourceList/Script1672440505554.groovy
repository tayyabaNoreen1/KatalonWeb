...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/GetCalls/GetResourceList'))
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/GetResources.txt', FailureHandling.OPTIONAL)
