...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/GetCalls/UserNotFound'))
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/UserNotFound.txt', FailureHandling.OPTIONAL)
