...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/GetCalls/GetUsers'), FailureHandling.OPTIONAL)
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/GetUsers.txt', FailureHandling.OPTIONAL)
