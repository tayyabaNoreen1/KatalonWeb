...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/GetCalls/ResourceNotFound'))
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/ResourceNotFound.txt', FailureHandling.OPTIONAL)
