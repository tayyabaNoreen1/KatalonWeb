...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/GetCalls/GetSingleResource'))
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/GetSingleResource.txt', FailureHandling.OPTIONAL)
