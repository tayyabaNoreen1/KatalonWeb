...
response = WS.sendRequest(findTestObject('Object Repository/APITesting/PostCalls/LoginSuccess'))
...
//Check Schema
conditionSchema = WS.validateJsonAgainstSchema(response, 'Resources/APITesting/LoginSuccess.txt', FailureHandling.OPTIONAL)
